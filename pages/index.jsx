// index5-onepage --- one page version of index5 --- original index is now index7
      ...
      <section className="what-we-offer pb-90 rpb-70">
        <div className="container container-1290">
          <div className="section-title text-center mb-60 wow fadeInUp delay-0-2s">
            ...
            <h2>Amazing Services For You</h2>
          </div>
          <div className="row justify-content-center">
            <div className="col-xl-3 col-lg-4 col-md-6">
              <div className="service-item style-three wow fadeInUp delay-0-2s">
                ...
                <h4>
                  <Link href="">Investment Consultation</Link>
                </h4>
            ...
            <div className="col-xl-3 col-lg-4 col-md-6">
              <div className="service-item style-three wow fadeInUp delay-0-2s">
                ...
                <h4>
                  <Link href="">Personalized Investment Goals</Link>
                </h4>
                {/* <Link href="service-details" className="more">
                  <i className="far fa-arrow-right" />
                </Link> */}
            ...
            <div className="col-xl-3 col-lg-4 col-md-6">
              <div className="service-item style-three wow fadeInUp delay-0-2s">
                ...
                <h4>
                  <Link href="">Liqudity management</Link>
                </h4>
                {/* <Link href="service-details" className="more">
                  <i className="far fa-arrow-right" />
                </Link> */}
            ...
            <div className="col-xl-7 wow fadeInUp delay-0-4s">
              ...
              >
                <div className="section-title mb-10">
                  ...
                  <h2>Take control, pave prosperity path. Contact Us</h2>
                </div>
                <p>
