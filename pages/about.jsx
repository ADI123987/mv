          ...
          <div className="row justify-content-center">
            <div className="col-lg-7">
              <div className="section-title text-center mb-70 wow fadeInUp delay-0-2s">
                ...
                <h2>Financial Freedom, Simplified.</h2>
              </div>
            </div>
          </div>
          <div className="row gap-90">
            <div className="col-lg-4 col-md-6">
              <div className="why-choose-item style-two wow fadeInUp delay-0-2s">
                ...
                <p>
                We connect our users with experienced advisors or automated AI tools who help discover the best investment strategies based on your risk appetite and your securely managed data.
                </p>
              </div>
            </div>
            <div className="col-lg-4 col-md-6">
              <div className="why-choose-item style-two wow fadeInUp delay-0-4s">
                <div className="why-choose-header">
                  ...
                  <h5>Personalized Investment Goals</h5>
                </div>
                <p>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="why-choose-item style-two wow fadeInUp delay-0-6s">
                <div className="why-choose-header">
                  ...
                  <h5>Liqudity management</h5>
                </div>
                <p>
                Gain a clear understanding of their financial  investments, helping them make smarter tracking and exit decisions.
                </p>
              </div>
            </div>
          </div>
